...
import {
  active_homing_missile, cluster_missile, container_missile, coral_missile,
  coral_shield, detonating_missile, diffuse_laser_canon, dual_missile,
  gatling_cannon, grenade_cannon, laser_canon, light_wave_cannon, missile, needle_missile, plasma_canon, plasma_missile,
  pulse_buckler, pulse_canon,
  pulse_scutum,
  pulse_shield, pulse_shield_launcher, scatter_missile, split_missile,
  spread_bazooka, stun_needle_launcher, vertical_missile
